namespace Loupedeck.MicrosoftTeamsPlugin.Actions
{
    ...
    public class AdjustZoom : PluginDynamicAdjustment
    {
        ...
        public AdjustZoom() : base(displayName: "Zoom", description: "Dial Zooms in or out, click resets zoom to fit.", groupName: "General", hasReset: true)
        {
        ...
        protected override void ApplyAdjustment(String actionParameter, Int32 diff)
        {
            ...
            if (diff > 0)
            {
                for (var i = 0; i < diff; i++)
                {
                    this.Plugin.ClientApplication.SendKeyboardShortcut(VirtualKeyCode.Equals, ModifierKey.Control);
                }
            }
